...
const BalanceNumberContent = {
  num1: `<p>There is a lot to be said for being self-reliant and drawing strength from deep within, but you likely need to open up more and share the difficulties you face with others who love you. Your tendency will always be to withdraw and face these challenges alone but the kind of isolation that results from that can work against you. Seek other people's advice. It will only help you broaden your perspective on things. No one is saying you have to take the advice every time, but it will benefit you greatly to have exposure to other points of view. Regardless of the situation or how you decide to handle it, learn to draw strength from your creative side. Sometimes, the unconventional solutions are the ones that work the best.</p>`,
  num2: `<p>Tact and diplomacy are your best weapons in all personal battles. Leave your emotions out of it. They will only slow you down. Have faith in yourself and have trust in your intuition. The solution will present itself if you just trust your ability to see it. Face your problems head-on. Never cower. Never retreat. Work on defusing as many bombs as possible before they explode. You know what they say about an ounce of prevention....
  <br><br>
  Do stand up to your problems but also be willing to compromise in the interest of conflict resolution. Keep everything in proper perspective and don't make more of a problem out of something than there is to be made. Your sensitive nature can throw things off balance. Learn how to stay centered and focused. You attract harmony and balance as part of your nature so take advantage of this. You have the opportunity to be a person who brings peace to volatile situations. Use this ability for the greater good.</p>`,
  num3: `<p>Approach issues and problems with a light heart and a positive outlook. Consider the impact on all parties involved and actively pursue the solution that works out best for everyone. Use your natural magnetism and influence to steer things toward an agreeable solution. You tend to let your emotions run away with you when faced with difficulties. Try to get this tendency under control; you are going to need an objective eye, ear, voice and brain if you are going to see the best outcomes. Don't get too personally invested in problem-solving either or else you will likely miss the best solution when it presents itself.</p>`,
  num4: `<p>Try not to take issues that have emotional impact too hard. Keep you anger in check. Remember that self-discipline is your greatest ally so learn how to cultivate it when life is simple so you have that skill to pull out when things get complicated.
  <br><br>
  Keep your focus on the big picture and bear in mind that in life there is always going to be give and take. Remember that justice should always be balanced and tempered with mercy. Do not withhold forgiveness and try to view the things that people do that make you angry with an attitude of compassion. DECIDE that you are going to understand and relate. Always be willing to take that all-important walk in the other guy's shoes. Try to view the situation from the perspective of your adversary and be willing to see what IS, not what you perceive. There are always aspects of every problem that we naturally want to ignore or work around. Be prepared to face them and deal with them.</p>`,
  num5: `<p>Focus on your problems. Give them your full attention. The worst thing you can do is avoid them. You tend to actively seek out distractions to get your mind off your problems as a sort of defense mechanism. Become more willing to drop your defenses and let things happen. You may have a tendency to cling to things like alcohol, drugs or other vices to feel safe so watch for warning signs that these behaviors might surface. You are totally capable of finding solutions to your problems, even if it means having to get creative. You understand problems and can see the way through them better than you think.</p>`,
  num6: `<p>You see beyond the surface of things and find it easy to recognize the source of conflict. The problem is that you are better at identifying it than you are at dealing with it, so you tend to defer quite a bit to friends and family. You look to others for advice and also for comfort when the pressure gets to be too much. You also have a tendency to avert your attention away from conflict as a defense mechanism. The bottom line is that if you're involved, you shoulder at least some of the weight of resolving the conflict so figure out a way to accept it and deal with it.</p>`,
  num7: `<p>You tend to retreat to a place inside your head that feels safe in an effort to avoid dealing with issues and problems. The real issue is you devaluing your own ability to deal with things. You are beyond capable of seeing a solution and implementing it, but your own self-doubt slows the process to a crawl most of the time. The problem here isn't the conflict itself. The real problem is you. Learn how to stand up to your doubts and inhibitions. Don't try to intimidate them into submission, just acknowledge them and assure them that everything is under control. You will be amazed how quickly everything will fall into place when you do that.</p>`,
  num8: `<p>You have a lot of natural-born power and ability in a certain area. No doubt you've heard this before. Now it is time to figure out how to use it to achieve balance in all aspects of your life, including conflict resolution. Your tendency is to be manipulative. This needs to change. There is a huge difference between influence and manipulation. You are more than capable of the former so stop resorting to the latter. It's a confidence issue with you. Stop letting fear, apprehension and self-doubt hinder you from operating within your full potential.
  <br><br>
  Part of being the person you are and having the abilities you possess is being able to shoulder responsibility in conflict, whether it began with you or not. You have the ability, now work on the will. You are a creative thinker and that means you can also come up with unconventional, yet very effective, solutions to most problems. Go with your gut instinct and take ownership of the problem. Chances are you're the only one who can exact a viable solution. You are capable of doing a lot of good or a lot of damage with your abilities. Opt for good. It may not always be the easiest decision, but the rewards, both personally and for other people, will far outweigh the struggles.</p>`,
  num9: `<p>Listen to other people who are in the midst of conflict or who are going through the same troubles you are. Your ability to empathize is what will help you solve the problem. You are able to understand what people are going through even if you've never been in their position. When you say, “I know how you feel...” it is a literal truth. You just know. The problem is that you also tend to look down on those who suffer with a sort of, “Thank goodness that's not ME...” sort of attitude.
  <br><br>
